...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="nsk-airflow-projects-gds-dev")
    bq_project = Variable.get("bq_project", default_var="project-0bc8a567-62b7-4045-a22")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "1061956692764-compute@developer.gserviceaccount.com",
